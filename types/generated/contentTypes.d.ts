...
export interface ApiReplayReplay extends Schema.CollectionType {
...
export interface ApiTaskTask extends Schema.CollectionType {
  ...
  attributes: {
    taskField: Attribute.Text;
    tags: Attribute.Enumeration<
      ['Javascript', 'React', 'Strapi', 'Next js', 'JQuery']
    >;
    replays: Attribute.Relation<
      'api::task.task',
      'oneToMany',
      'api::replay.replay'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::replay.replay': ApiReplayReplay;
